...
#If you want to look at a spcecific number of observations with the highest Cook’s distance to assess them further:
model1B.diag.metrics %>%
  top_n(9, wt = .cooksd)
